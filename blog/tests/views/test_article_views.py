...
class ArticleDetailViewTestCase(TestCase):
    ...
    def test_article_detail_view_url_by_name(self):
        response = self.client.get(reverse('blog:article_detail',
                                           kwargs={'slug': self.article.slug,
                                                   'username': self.article.minister.username.lower()
                                                   }))
        self.assertEqual(response.status_code, 200)
    ...
    def test_if_article_detail_view_returns_the_right_article_details(self):
        ...
        self.assertEqual(response.context["article"].minister,
                         self.article.minister)
...
class ArticleCreateViewTestCase(TestCase):
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUsed(response, "dashboard/minister/article_create_form.html")
    ...
    #
    #     article = mommy.make(Article, body="test", image_credit="new", minister=self.minister, status='PUBLISHED')
    ...
    #                      article.slug)
    #     self.assertEqual(response.context_data['article'].minister,
    #                      article.minister)
...
#                                               password='1X<ISRUkw+tuK')
#         test_user2.save()
#         self.articles = mommy.make(Article, minister=test_user1,  _quantity=5)
#
#     def test_article_minister_can_delete_article(self):
#         self.client.login(username='testuser1', password='1X<ISRUkw+tuK')
#
...
#
#     def test_unministerized_minister_cannot_delete_article(self):
...
#         self.article = mommy.make(Article, minister=self.test_user1)
#
#     def test_redirect_if_not_logged_in(self):
...
#
#         When the minister is logged, if he/she goes to the article he/she wants
