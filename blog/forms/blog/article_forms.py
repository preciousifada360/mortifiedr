...
class ArticleCreateForm(forms.ModelForm):
    ...
    class Meta:
        ...
        model = Article
        fields = ["title", "category", "image", "image_credit", "body", "download_url", "tags", "status"]
        widgets = {
            ...
            'image_credit': TextInput(attrs={
                'name': "image_credit",
                'class': "form-control",
                'placeholder': "Example: google.com (The Holy Bible Book Cover Image)",
                'id': "image_credit"
            }),
            ...
            'download_url': TextInput(attrs={
                        'name': "article-download",
                        'class': "form-control",
                        'placeholder': "Enter Article Download URL",
                        'id': "article-download"
                        }),
