...
class Article(models.Model):
    ...
    minister = models.ForeignKey(User, on_delete=models.CASCADE,
                               related_name='articles')
    ...
    download_url = models.URLField(max_length=250, null=True, blank=True, default="")
    ...
    def get_absolute_url(self):
        return reverse('blog:article_detail', kwargs={'username': self.minister.username.lower(), 'slug': self.slug})
