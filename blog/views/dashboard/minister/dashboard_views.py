...
class DashboardHomeView(LoginRequiredMixin, View):
    ...
    """
    context = {}
    template_name = 'dashboard/minister/dashboard_home.html'

    def get(self, request, *args, **kwargs):
        """
        Returns the minister details
        """

        articles_list = Article.objects.filter(minister=request.user)
...
class ArticleWriteView(LoginRequiredMixin, View):
    ...
    template_name = 'dashboard/minister/article_create_form.html'
    context_object = {}
    ...
    def post(self, request, *args, **kwargs):
        ...
        if action == self.SAVE_AS_DRAFT:
            ...
            if article_create_form.is_valid():
                ...
                new_article.minister = request.user
...
class ArticleUpdateView(LoginRequiredMixin, View):
    ...
    template_name = 'dashboard/minister/article_update_form.html'
    context_object = {}
    ...
    def post(self, request, *args, **kwargs):
        ...
        if action == self.SAVE_AS_DRAFT:
            ...
            if not request.user == old_article.minister.username:
            ...
            if article_update_form.is_valid():
                ...
                updated_article.minister = request.user
...
class ArticleDeleteView(LoginRequiredMixin, View):
    ...
    def get(self, *args, **kwargs):
        ...
        if not self.request.user.username == article.minister.username:
...
class DashboardArticleDetailView(LoginRequiredMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        """
        template_name = 'dashboard/minister/dashboard_article_detail.html'
        context_object = {}
...
class ArticlePublishView(LoginRequiredMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        """
            ...
            then save the article and redirects the minister to his/her published
            articles.
        """
        article = get_object_or_404(Article, slug=self.kwargs.get('slug'))
...
class MinisterWrittenArticlesView(LoginRequiredMixin, View):
    """
       Displays all articles written by an minister.
    """

    def get(self, request):
        """
           Returns all articles written by an minister.
        """
        template_name = 'dashboard/minister/minister_written_article_list.html'
        context_object = {}

        written_articles = Article.objects.filter(minister=request.user.id, deleted=False).order_by('-date_created')
...
class MinisterPublishedArticlesView(LoginRequiredMixin, View):
    """
       Displays published articles by an minister.
    """

    def get(self, request):
        """
           Returns published articles by an minister.
        """
        template_name = 'dashboard/minister/minister_published_article_list.html'
        context_object = {}

        published_articles = Article.objects.filter(minister=request.user.id,
...
class MinisterDraftedArticlesView(LoginRequiredMixin, View):
    """
       Displays drafted articles by an minister.
    """

    def get(self, request):
        """
           Returns drafted articles by an minister.
        """
        template_name = 'dashboard/minister/minister_drafted_article_list.html'
        context_object = {}

        drafted_articles = Article.objects.filter(minister=request.user.id,
...
class MinisterDeletedArticlesView(LoginRequiredMixin, View):
    """
       Displays deleted articles by an minister.
    """

    def get(self, request):
        """
           Returns deleted articles by an minister.
        """
        template_name = 'dashboard/minister/minister_deleted_article_list.html'
        context_object = {}

        deleted_articles = Article.objects.filter(minister=request.user.id,
